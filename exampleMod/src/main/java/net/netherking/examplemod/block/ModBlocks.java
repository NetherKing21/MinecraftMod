...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> THICC_SLIME = registerBlock( "thicc_slime", () -> new Block(BlockBehaviour.Properties.copy(Blocks.SLIME_BLOCK).speedFactor(0.1F).sound(SoundType.MUD)));
